...
const SITE = {
  ...
  // Logo: using David's existing logo. Recommended: download it into
  // assets/img/logo.jpg and change this to "assets/img/logo.jpg".
  logo: "https://electmisterrogers.com/wp-content/uploads/cropped-rogers-icon.jpg",
